...
const title = "Listing Form";
const selectTypeText = "Select a Type";
const selectCategoryText = "Select a Category";
const changecategoryText = "Change Category";
const selectLocationText = "Select Location";
const eligibilityCheckingText = "Checking Author Eligibility";
const remainingAdsText = "Sorry! You have no remaining ads";
const purchaseMembershipText =
  "Please purchase or renew your subscription to post more ads";
const membershipURL =
  "https://suremarket.ng/";
...
const NewListingScreen = ({ navigation }) => {
  const [
    { newListingScreen, user, listing_locations, auth_token },
    dispatch,
  ] = useStateValue();
  const nav = useNavigation();
  const [adTypePickerVisible, setAdTypePickerVisible] = useState(false);
  ...
  const handleCategorySelection = (item) => {
    ...
    setCatLoading((prevCatLoading) => true);
    ...
    api
      ...
      .then((res) => {
        if (res.ok) {
          ...
          setCatLoading((prevCatLoading) => false);
        } else {
          //print error
        }
      });
                ...
                {newListingConfig.eligible && (
                  ...
                  >
                    <View style={styles.typeTitleWrap}>
                      ...
                      <Text style={styles.typeTitle}>{selectTypeText}</Text>
                    </View>
                          ...
                          {adType ? (
                            <>
                              <TouchableOpacity
                                style={styles.typePickerFieldWrap}
                                onPress={() => {
                                  // setAdTypePickerVisible(!adTypePickerVisible);
                                  setAdType();
                                  setCategories({});
                                  setCurrentCategories([]);
                                  setNoSubCat(false);
    ...
    <>
      ...
      <View style={styles.noUserViewWrap}>
        <View style={styles.noUserTitleWrap}>
          <Text style={styles.noUserTitle}>You are not logged in</Text>
          <Text style={styles.noUserMessage}>
            Please login or signup to create a post
          </Text>
